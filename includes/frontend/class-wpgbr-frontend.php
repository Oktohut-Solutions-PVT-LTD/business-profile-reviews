...
class Wpgbr_Frontend
{
    ...
    public function load_scripts_styles()
    {
        ...
        if ( $flag ) {
            wp_enqueue_style(
                'wpgbr_main_css',
                WPGBR_PLUGIN_URL . '/assets/frontend/css/wpgbr-style.css',
                false,
                '1.0.0'
            );
            wp_enqueue_script(
                'wpgbr_main_js',
                WPGBR_PLUGIN_URL . '/assets/frontend/js/wpgbr-main.js',
                array( 'jquery' ),
                '1.0.0'
            );
    ...
    public function load_widget_template()
    {
        ...
        if ( $placeId ) {
            ...
            if ( $business_info ) {
				...
				<?php
                $business_pic = WPGBR_PLUGIN_URL . '/assets/frontend/img/logo.png';
                ...
                ?> Reviews</span>
						...
						<button class="btn-close" onclick="wpgbr.closeDiv()">
							<img src="<?php
                echo  esc_attr( WPGBR_PLUGIN_URL . '/assets/frontend/img/' . $close_img ) ;
                ?>" alt="">
                ...
                ?>"
							   class="wpgbr-action-button"> <img
										src="<?php
                echo  esc_attr( WPGBR_PLUGIN_URL . '/assets/frontend/img/pen.png' ) ;
                ?>" alt="">
								Write
								A Review</a>
						</div>
                ...
                ?>"
					...
					<div class="wp-gbr-viewer-footer">
						<img src="<?php
                echo  esc_attr( WPGBR_PLUGIN_URL . '/assets/frontend/img/' . $google_img ) ;
                ?>"
							 alt="">
                ...
                ?>" onclick="wpgbr.openDiv()">
					...
					<div href="#" target="_blank" id="wp-gbr-button" class="inline-flex">
						<img src="<?php
                echo  esc_attr( WPGBR_PLUGIN_URL . '/assets/frontend/img/google.svg' ) ;
                ?>" alt=""
							 width="34">
						<div class="ml-2">
							<div class="inline-flex justify-space-around">
    ...
    public function get_rating_stars( $rating ) : string
    {
        ...
        if ( $rating > 4.5 ) {
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            ...
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star-half.svg') . '" alt="">';
        } elseif ( $rating > 3.5 && $rating <= 4 ) {
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            $op .= '<img src="' . esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star.svg') . '" alt="">';
            $op .= '<img src="' .  esc_attr(WPGBR_PLUGIN_URL . '/assets/frontend/img/star-empty.svg') . '" alt="">';
