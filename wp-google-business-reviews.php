...
Plugin URI: https://wp-hut.in/business-reviews-bundle-wordpress-plugin
Description: Display your Google business profile reviews to your site
Version: 1.0.0
Author: WP-HUT <support@wp-hut.in>
Author URI: https://wp-hut.in
...
define( 'WPGBR_ASSETS_URL', WPGBR_PLUGIN_URL . '/assets/' );
define( 'WPGBR_MENU_URL', WPGBR_PLUGIN_URL . '/assets/admin/img/menu.png' );
